...
public class ViewBlueConveyorBelt {
    ...
    public static void insertBlueConveyorBelt(SpaceView spaceView, FieldAction fieldAction) {
        ...
        try {
            Image conveyorPointRight = new Image("Images/blueConveyorRight.png", 50, 50, true, true);
            Image conveyorPointLeft = new Image("Images/blueConveyorLeft.png", 50, 50, true, true);
            Image conveyorPointUp = new Image("Images/blueConveyorUp.png", 50, 50, true, true);
            Image conveyorPointDown = new Image("Images/blueConveyorDown.png", 50, 50, true, true);
